...
class HikageViewRenameHandler : RenameHandler {
    ...
    private companion object {
        const val PERFORMER_RENAME_UNAVAILABLE_MESSAGE = "Cannot perform refactoring.\n" +
    ...
    override fun isAvailableOnDataContext(dataContext: DataContext): Boolean {
        ...
        val element = CommonDataKeys.PSI_ELEMENT.getData(dataContext) ?: caretElement ?: return false
        ...
        val performer = HikageViewRenameTargetResolver.isPotentialGeneratedPerformer(element)
        val protectedImport = caretElement.findHikageWidgetImport() ?: element.findHikageWidgetImport()

        return view != null || performer || protectedImport != null
    }
