...
/**
 * Executes the wrapper-independent read-only XML layout conversion pipeline.
 */
object XmlLayoutConverter {
     ...
     * @return the normalized layout tree and structured conversion diagnostics.
     */
    fun convert(file: XmlFile, rootLayoutParamsClass: String?): ConversionOutcome<KotlinLayoutNode> {
        ...
        val resolved = XmlLayoutModelResolver.resolve(
            ...
            rootLayoutParamsClass = rootLayoutParamsClass,
        ...
        return ConversionOutcome(
            value = resolved.value?.takeUnless {
