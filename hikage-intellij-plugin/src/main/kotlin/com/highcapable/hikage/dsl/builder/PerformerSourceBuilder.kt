...
object PerformerSourceBuilder {
    ...
    private val viewGroupClass = AndroidSymbols.VIEW_GROUP_CLASS.toClassName()
    private val viewGroupLayoutParamsClass = AndroidSymbols.VIEW_GROUP_LAYOUT_PARAMS_CLASS.toClassName()
