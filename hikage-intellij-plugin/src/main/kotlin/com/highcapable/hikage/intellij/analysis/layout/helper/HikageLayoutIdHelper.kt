...
import com.highcapable.hikage.intellij.analysis.layout.model.HikageLayout.Root
...
class HikageLayoutIdHelper(
    ...
    private fun scanCall(
        ...
        val ownResult = ScanResult(
            ...
            ids = id?.takeIf(String::isNotEmpty)
                ?.let { listOf(Id(it, viewClass, idExpression)) }
                .orEmpty()
        )
    ...
    private fun scanLayoutCall(
        ...
        else listOf(Id(id, root.viewClass, idExpression))
