 ...
 */
package com.highcapable.hikage.intellij.settings.bundle
...
/**
 * Provides localized messages for plugin's Settings UI.
 */
internal object SettingsBundle {
    ...
    private val bundle = DynamicBundle(classOf<SettingsBundle>(), BUNDLE)
